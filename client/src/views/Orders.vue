<template>
  <div class="orders">
    ...
    <div v-else>
      ...
      <div v-if="submittedRestockOrders.length > 0" class="card">
        <div class="card-header">
          <h3 class="card-title">{{ t('orders.submittedOrders') }} ({{ submittedRestockOrders.length }})</h3>
        </div>
          ...
          <table class="restock-orders-table">
            ...
            <tbody>
              <tr v-for="order in submittedRestockOrders" :key="order.id">
                ...
                <td class="col-lead-time">{{ t('orders.daysCount', { count: order.lead_time_days }) }}</td>
              </tr>
            </tbody>
          </table>
        </div>
